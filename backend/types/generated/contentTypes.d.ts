...
export interface ApiCurrentRoundCurrentRound extends Schema.SingleType {
  collectionName: 'current_rounds';
  info: {
    singularName: 'current-round';
    pluralName: 'current-rounds';
  ...
  attributes: {
    round: Attribute.Integer;
    live: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMatchMatch extends Schema.CollectionType {
  ...
  attributes: {
    playerAway: Attribute.Relation<
      'api::match.match',
      'oneToOne',
      'api::player.player'
    >;
    goalsHome: Attribute.Integer;
    goalsAway: Attribute.Integer;
    roundNumber: Attribute.Integer;
    playerHome: Attribute.Relation<
      'api::match.match',
      'oneToOne',
      'api::player.player'
    >;
...
export interface ApiSummarySummary extends Schema.CollectionType {
  ...
  attributes: {
    ...
    goalsScored: Attribute.Integer;
    goalsLost: Attribute.Integer;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::current-round.current-round': ApiCurrentRoundCurrentRound;
